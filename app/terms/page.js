export const metadata = {
    title: "Terms of Service - Ballard Kelly Scott",
                    ...
                    <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8 sm:p-12">
                        <div className="prose prose-lg max-w-none">
                            <p className="text-xl text-gray-700 mb-8">
                                Welcome to Ballard Kelly Scott. By engaging our web design services, you agree to be bound by these Terms of Service.
                            </p>

                            <h2 className="text-3xl font-bold mt-12 mb-6">1. Services</h2>
                            <p className="text-gray-700 mb-6">
                                Ballard Kelly Scott provides professional web design and development services. The specific services, deliverables, timeline, and pricing will be outlined in a separate project agreement or proposal.
                            </p>
                            ...
                            <p className="text-gray-700 mb-4">
                                <strong>6.2 Portfolio Rights:</strong> Ballard Kelly Scott reserves the right to display completed projects in our portfolio and marketing materials unless otherwise agreed in writing.
                            </p>
                            <p className="text-gray-700 mb-6">
                            ...
                            <p className="text-gray-700 mb-6">
                                Ballard Kelly Scott&apos;s liability is limited to the amount paid for the services. We are not liable for indirect, incidental, or consequential damages.
                            </p>
                            ...
                            <div className="bg-blue-50 p-6 rounded-xl mt-4">
                                <p className="text-gray-800 mb-2"><strong>Ballard Kelly Scott</strong></p>
                                <p className="text-gray-700 mb-2">BallardKellyScott.shop</p>
